...
{\noindent\Huge\bfseries Notes Collection of \\[0.5\baselineskip] WordPress}\\[2\baselineskip] % Title
{\large \textit{WordPress}}\\[4\baselineskip] % Tagline or further description
